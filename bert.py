...
def correct_topk(text):
    ...
    predicted_tokens = [tokenizer.convert_ids_to_tokens([predicted_index])[0] for predicted_index in predicted_indexs.tolist()]
...
SUFFIXS = ['s', 'es', 'ly']
SPEC_NONES = ['january', 'february', 'march', 'april', 'june', 'july', 'august', 'september', 'october', 'november', 'december']
